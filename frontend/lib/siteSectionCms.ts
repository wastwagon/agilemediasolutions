...
export const SITE_SECTION_DEFINITIONS: SiteSectionDefinition[] = [
  ...
  {
    key: 'newhomepage.whyUsBento',
    title: 'Concept homepage — Who we are (stats grid)',
    description:
      'Awsa-style bento on `/newhomepage`: specialty line, optional mark image, three headline stats, and the bottom-right CTA tile (also reused for FAQ hover card copy).',
    fields: [
      { id: 'specialtyTagline', label: 'Specialty tile line (uppercase)', description: 'Shown under the mark on the tall left tile.' },
      {
        id: 'specialtyMarkUrl',
        label: 'Specialty tile mark image',
        kind: 'image',
        description: 'Optional. Leave blank to use the template Webflow-style mark asset.',
      },
      { id: 'stat1Value', label: 'Stat 1 — number' },
      { id: 'stat1Suffix', label: 'Stat 1 — suffix (e.g. +)' },
      { id: 'stat1Label', label: 'Stat 1 — label' },
      { id: 'stat2Value', label: 'Stat 2 — number' },
      { id: 'stat2Suffix', label: 'Stat 2 — suffix (e.g. +)' },
      { id: 'stat2Label', label: 'Stat 2 — label' },
      { id: 'stat3Value', label: 'Stat 3 — number' },
      { id: 'stat3Suffix', label: 'Stat 3 — suffix (e.g. + or empty)' },
      { id: 'stat3Label', label: 'Stat 3 — label' },
      { id: 'ctaTitle', label: 'CTA tile — main headline' },
      { id: 'ctaSub', label: 'CTA tile — subline (optional)', multiline: true },
      { id: 'ctaHover', label: 'CTA tile — small top-left label' },
    ],
  },
  {
    key: 'newhomepage.faq',
    title: 'Concept homepage — FAQ',
    description:
      'Accordion on `/newhomepage`. One question per row, using `Question :: Answer`. Answers may be long; only the first `::` on each line separates question from answer.',
    fields: [
      {
        id: 'qaPairs',
        label: 'Questions & answers',
        kind: 'pairs',
        pairLeftPlaceholder: 'Question',
        pairRightPlaceholder: 'Answer',
      },
    ],
  },
  {
