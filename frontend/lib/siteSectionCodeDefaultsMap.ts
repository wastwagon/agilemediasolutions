...
export const SITE_SECTION_CODE_DEFAULTS: Record<string, Record<string, string>> = {
  ...
  /** Concept homepage (`/newhomepage`) — Awsa-style stats grid + specialty tile + CTA card (editable in Site Content). */
  'newhomepage.whyUsBento': {
    specialtyTagline: 'STRATEGIC COMMUNICATIONS & MEDIA',
    specialtyMarkUrl: '',
    stat1Value: '120',
    stat1Suffix: '+',
    stat1Label: 'CLIENTS WORLDWIDE',
    stat2Value: '98',
    stat2Suffix: '+',
  ...
  /** Concept homepage (`/newhomepage`) — FAQ accordion. One row per line: `Question :: Answer`. */
  'newhomepage.faq': {
    qaPairs: `What services do you offer? :: We provide strategic communications and narrative building, media relations and reputation management, campaigns and stakeholder engagement, digital and social communications, branding and design, and event media and summit support—tailored for governments, institutions, brands, and movements.
How long does a typical engagement take? :: Timelines depend on scope, approvals, and channels. Short sprint programmes can run in a few weeks; larger institutional campaigns or rebrands may span several months. We agree milestones up front and report progress clearly.
Do you work across regions and languages? :: Yes. We collaborate across African markets and globally, adapting messaging, translation, and media outreach to each audience and regulatory context.
How do we get started? :: Use the contact form on this page or reach us through the main contact page. Share your goals, timeline, and stakeholders—we will follow up with practical next steps and, where useful, a discovery conversation.`,
  },
  'home.servicesBand': {
    label: 'Capabilities',
    title: 'Our services',
