...
/** TopBar + Header + footer + mobile tab bar — only mounted for `app/(site)/*` routes (not /newhomepage). */
export default function MainSiteChrome({ children }: { children: React.ReactNode }) {
  ...
  useScrollAnimations(true, pathname ?? '');
