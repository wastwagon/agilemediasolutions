      ...
      <div className="careers-content">
        ...
        <div className="careers-block careers-opportunities">
          ...
          <ul className="careers-opportunities-grid">
            <li className="careers-opportunity-card"><span className="careers-opportunity-title">Full-Time Positions</span><span className="careers-opportunity-desc">Join our leadership or delivery teams</span></li>
            <li className="careers-opportunity-card"><span className="careers-opportunity-title">Consultant Roster</span><span className="careers-opportunity-desc">Project-based roles across regions and specialties</span></li>
            <li className="careers-opportunity-card"><span className="careers-opportunity-title">Fellowships & Internships</span><span className="careers-opportunity-desc">For emerging creatives, writers, and strategists</span></li>
            <li className="careers-opportunity-card"><span className="careers-opportunity-title">Creative Collaborators</span><span className="careers-opportunity-desc">Visual artists, animators, musicians, illustrators</span></li>
          </ul>
        </div>
        ...
        <div className="careers-cta-strip">
          <div className="careers-cta-inner">
            <p className="careers-cta-text">Ready to shape the narrative?</p>
            <div className="careers-cta-buttons">
              <a href="/contact#contact" className="btn btn-careers-primary">See Open Positions</a>
              <a href="/contact#contact" className="btn btn-careers-outline">Join Our Talent Network</a>
              <a href="/index#who-we-are" className="btn btn-careers-outline">Meet Our Team</a>
            </div>
          </div>
        </div>
      </div>
