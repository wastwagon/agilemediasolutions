...
const SITE_SECTION_SEEDS = [
  ...
  },
  {
    ...
    content: {
      ...
      presenceSubtitle: `Address: ${PUBLIC_HEAD_OFFICE_LINE}. Additional locations in Nairobi and Johannesburg—we are available across time zones and channels to discuss ideas, opportunities, and collaborations.`,
      metaTitle: '',
      metaDescription: '',
    },
  },
